...
class VideoPlayerScreen extends StatelessWidget {
  ...
  const VideoPlayerScreen({Key? key, required this.infoVideo})
      : super(key: key);
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                    height: size.iScreen(
                        0.5)), // Espaciado entre el título y la descripción
                ...
                SizedBox(
                    height: size
                        .iScreen(0.5)), // Espaciado adicional si es necesario
...
String? extractVideoId(String url) {
  ...
  // Si la URL es de tipo youtube.com con /shorts/
  if (uri.host.contains('youtube.com') &&
      uri.pathSegments.isNotEmpty &&
      uri.pathSegments.first == 'shorts') {
    return uri.pathSegments[1]; // El ID del video está después de 'shorts/'
  }
